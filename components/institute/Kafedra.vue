...
<template>
  <div class="flex justify-center items-center main_branch">
    ...
    >
      <div
        class="w-[340px] bg-white rounded-xl 2xl:px-6 2xl:pt-6 2xl:pb-5 min-h-[146px] flex flex-col justify-between xl:w-[100%] xl:px-4 xl:pb-4 xl:pt-4 lg:w-[100%] lg:px-3 lg:pb-3 lg:pt-3 md:w-[100%] md:px-3 md:pb-3 md:pt-3 sm:w-[300px] sm:pb-3 sm:pt-3 sm:px-3 main_box_wrapper"
      ...
      >
        ...
        <router-link
          class="font-normal text-base text-[#5D5D5F] wrapper_bot cursor-pointer flex justify-between items-center"
          :to="
