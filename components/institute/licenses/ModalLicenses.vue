...
<template>
    <div>
        ...
        <UModal  class="box_hidden" v-model="props.isOpen" prevent-close>
            <UCard class="2xl:w-[1036px] lg:w-[1000px] h-[539px] md:w-[750px]  custom-modal p-2  box_height  bg-white" style="background-color:white"  >

                <div class="flex justify-between lg:gap-3 box_flex  h-full">
                    
                    <div class="md:w-[324px] box_block">
                        <img :src="props.items[itemIndex]?.photo[store.currentImage]" alt="certifacate img">
                        
                    </div>



                    <div class="lg:w-[592px] sm:w-[400px] flex flex-col justify-between h-full ">
                        ...
                        <div>
                            ...
                            <p class=" text-[#868587] mt-4" v-html="props.items[itemIndex]?.description">
