<template>
  <div class="w-full">
  <div class="w-full" v-if="props.data && props.data.department_boss">
      <div class="bg-white rounded-xl cursor-pointer p-8">
        ...
        >
          ...
          >
            ...
            <div class="mt-6" v-if="props.data && props.data.department_boss && props.data?.department_boss?.dec">
              <div>
                <p
                  ref="text"
                  class="text"
                  v-html="props.data?.department_boss?.dec[$i18n.locale]?.substring(0, expanded)"
                ></p>
                <button
    ...
    <div
      ...
      v-if="
        props.data &&
        props.data.simple_employee &&
        props.data.simple_employee.length > 0
      "
    >
