<template>
  <div class="main_branch">
   ...
   <pre>
    ...
    <div class="main_branch">
        <h1 class="font-Halvar font-medium text-black text-[28px] my-6 mt-20">Xodimlar</h1>
      ...
      >
        <div
          ...
          :key="item"
          @click="$router.push(`/institute/details/kafedra/${item?.employ_meta.id}`)"
        >
          ...
          <div class="flex box_wrapper_pad flex-col justify-center pl-6">
            ...
            <p class="mt-2 text-[#88929D]" v-html="item?.dec[$i18n.locale]">
