<template>
  <div class="vacancy-container">
    ...
    >
      ...
      >
        <!-- {{vacancy}} -->
        <h2 class="font-medium text-xl mb-2" v-html="vacancy.title"></h2>
        <hr />
        <div
          class="flex items-center font-normal text-base text-gray-500 mb-2 pt-3"
        >
...
const steorHome = useHomeStore();
const vacansiec1 = ref(null);
const route = useRoute();

onMounted(() => {
  store.getVacansiec().then(() => {
