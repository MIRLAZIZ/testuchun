...
//     id: 1,
//     description:
//       "Toshkent menejment va iqtisodiyot instituti Ichki tartib qoydalari",
//   },
...
<template>
  <div class="flex justify-center items-start main_branch">
    ...
    >
     ...
     {{ item?.title?.length > 30 ? item?.title?.slice(0, 60) + "..." : item?.title }}          
        </h1>
        ...
        >
        <a :href="item.link" class="flex justify-between w-full" target="_blank">
